...
class TexFontTemplateLibrary(Scene):
    ...
    Please Note:
    Many of the in the TexFontTemplates collection require that specific Text
    ...
    def construct(self):
        ...
        examples = [
            ...
            TexFontTemplates.gnu_freesans_tx,  # "GNU FreeSerif (and TX Text symbols)"
            ...
            TexFontTemplates.minion_pro_myriad_pro,  # "Minion Pro and Myriad Pro (and TX Text symbols)"
            TexFontTemplates.minion_pro_tx,  # "Minion Pro (and TX Text symbols)"
            ...
            TexFontTemplates.vollkorn,  # "Vollkorn (TX Text for Greek and math symbols)"
